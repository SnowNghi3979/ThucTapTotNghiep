...
const OrderPage = () => {
  ...
  const diliveryPriceMemo = useMemo(() => {
    if(priceMemo >= 10000 && priceMemo < 400000){
      return 10000
    }else if(priceMemo >= 400000 || order?.orderItemsSlected?.length === 0) {
      return 0
    } else {
      return 20000
    }
          ...
          <WrapperRight>
            <div style={{width: '100%'}}>
              {/* <WrapperInfo>
                <div>
                  <span>Địa chỉ: </span>
                  <span style={{fontWeight: 'bold'}}>{ `Phường/Xã: ${user?.address} ,Tỉnh/TP: ${user?.city}`} </span>
              ...
              <div>
                  <span>Địa chỉ: </span>
                  <span style={{fontWeight: 'bold'}}>{ `Quận: ${user?.address} ,Thành phố: ${user?.city}`} </span>
                  <span onClick={handleChangeAddress} style={{color: 'red', cursor:'pointer'}}>Đổi địa chỉ</span>
                </div>
              ...
              <WrapperTotal>
                ...
                <span style={{display:'flex', flexDirection: 'column'}}>
                  ...
                  <span style={{color: '#000', fontSize: '11px'}}>(Đã bao gồm phí giảm giá)</span>
                </span>
              </WrapperTotal>
            </div>
            <ButtonComponent
